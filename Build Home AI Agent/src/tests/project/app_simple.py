...
llm_text = ChatOllama(model="qwen2.5:7b", base_url="http://localhost:11434", tags=["nostream"])
llm_text_no_stream = ChatOllama(model="qwen2.5:7b", base_url="http://localhost:11434", tags=["nostream"], )
